...
gnome-terminal -- bash -c "source bin/activate; flask --app vm_configurator.py run -p 5000; exec bash"

# Start server flask Network
echo "Starting flask app network_configurator"
gnome-terminal -- bash -c "source bin/activate; flask --app network_configurator.py run -p 5001; exec bash"
